    ...
    <div>
      <div className=" mx-auto relative flex flex-col w-11/12 items-center justify-between text-white ">
        ...
        <div className=" mt-4 w-[90%] text-left md:text-center text-sm md:text-lg font-bold text-richblack-300">
          Join the best Ticket Support System for managing customer support
          inquiries and resolving issues efficiently.We have lots of features on
          our platform for the client to raise the issues and get it done within
          a day.
        </div>
