...
//getEnrolledTickets
export async function getUserTickets(token,dispatch){
    // const toastId = toast.loading("Loading...");
    dispatch(setProgress);
    let result = []
    try {
      console.log("BEFORE Calling BACKEND API FOR ENROLLED TICKETS");
      const response = await apiConnector(
        "GET",
        profileEndpoints.GET_USER_ENROLLED_TICKETS_API,
        null,
        {
          Authorisation: `Bearer ${token}`,
        }
      )
      console.log("AFTER Calling BACKEND API FOR ENROLLED TICKETS");
    //   console.log(
    //     "GET_USER_ENROLLED_TICKETS_API API RESPONSE............",
    //     response
    //   )
      ...
      console.log("GET_USER_ENROLLED_TICKETS_API API ERROR............", error)
      toast.error("Could Not Get Enrolled Tickets")
    }
...
export async function getAdminDashboard(token,dispatch){
  ...
  try {
    ...
    console.log("AFTER Calling BACKEND API FOR ADMIN DASHBOARD");
    // console.log(
    //   "GET_ADMIN_DASHBOARD_API API RESPONSE............",
    //   response
    // )
    ...
    console.log("GET_ADMIN_DASHBOARD_API API ERROR............", error)
    toast.error("Could Not Get Admin Dashboard")
  }
  dispatch(setProgress(100));
  // toast.dismiss(toastId)
  return result
